...
13 x 20x20 pixel-art creature animations sourced from
...
- Added second board port: Waveshare AMOLED-1.8 (368x448 portrait, SH8601, FT3168, XCA9554 IO expander).
- Migrated from Panlee SC01 Plus (480x320 IPS) to Waveshare 2.16" AMOLED (480x480 square). Full hardware/library swap.
...
- Fonts and icons re-scaled ~1.9x for the higher-DPI panel.
